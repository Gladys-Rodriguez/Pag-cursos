...
/*Importa archivos de conexión y funciones*/
	...
	if(!empty($_POST))
	{
		...
		{			
			$user_id = getValor('id_alumno', 'correo', $email);
			...
			$url = 'http://'.$_SERVER["SERVER_NAME"].'/prueba/cambia_pass.php?user_id='.$user_id.'&token='.$token;
			...
			if(enviarEmail($email, $nombre, $asunto, $cuerpo)){
				...
				echo "<a href='index_alumnos.php' >Iniciar Sesion</a>";
				exit;
			}
			} else {
	...
	<body>
		...
		<div class="container">				
			<div class="panel-body" >
				...
				<div class="form-link"><br><a href="index_alumnos.php">Iniciar Sesi&oacute;n</a></div>
				<br><br>

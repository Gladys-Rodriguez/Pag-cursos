...
include '../funcs/func_academia/funcs.php';
	...
	if(!empty($_POST))
	{
		...
		{			
			$user_id = getValor('id_academia', 'correo', $email);
			...
			$url = 'http://'.$_SERVER["SERVER_NAME"].'/prueba/academia/cambia_pass.php?user_id='.$user_id.'&token='.$token;
			...
			if(enviarEmail($email, $nombre, $asunto, $cuerpo)){
				...
				echo "<a href='index_academia.php' >Iniciar Sesion</a>";
				exit;
			}
			} else {
	...
	<body>
		...
		<div class="container">				
			<div class="panel-body" >
				...
				<div class="form-link"><br><a href="index_academia.php">Iniciar Sesi&oacute;n</a></div>
				<br><br>

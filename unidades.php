...
<html lang="en"><!--Clase para hacer uso de elemntos de html5-->
  <head>
    ...
    <p> A) Hello. I<select name="1" class="selectpicker" multiple data-max-options="1"> 
      <!--Clase para seleccionar valores-->
   ...
   <!--Fin de los cards-->
    ...
    <main class="container"> 
  <!--Clase para utilizar las 12 columnas de la pagina-->
    <div class="row pt-4" > 
  <!--Inicio del row -->
      <div class="col-4 ">
       <!--primera columna-->
        <p>1.Bye. Have a good evening </p> 
         <!--Primer ejercicio-->
